...
ALTER TABLE [Tag] WITH CHECK ADD
    CONSTRAINT [FK_TagPost_PostId] FOREIGN KEY([Id]) REFERENCES [Post]([Id]),
    CONSTRAINT [FK_TagPost_TagId] FOREIGN KEY([Id]) REFERENCES [Tag]([Id])
